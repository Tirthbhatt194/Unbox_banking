...
exports.getAllHealthInsuranceCheckOutInDetail = void 0;
...
const getAllHealthInsuranceCheckOutInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield healthInsuranceCheckoutModel_1.default.findAll({
        include: [
            {
...
exports.getAllHealthInsuranceCheckOutInDetail = getAllHealthInsuranceCheckOutInDetail;
