...
exports.getAllBlogInDetail = void 0;
...
const getAllBlogInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const blog = yield blogModel_1.default.findAll({
        include: [
            {
...
exports.getAllBlogInDetail = getAllBlogInDetail;
