...
exports.getAllInvestmentPlanCheckOutInDetail = void 0;
...
const getAllInvestmentPlanCheckOutInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield investmentPlanCheckOutModel_1.default.findAll({
        include: [
            {
...
exports.getAllInvestmentPlanCheckOutInDetail = getAllInvestmentPlanCheckOutInDetail;
