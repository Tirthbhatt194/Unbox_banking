...
exports.getOneInvestmentPlanCheckOutInDetail = void 0;
...
const getOneInvestmentPlanCheckOutInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // find all data and join respective foreign key tables to it
    const proj = yield investmentPlanCheckOutModel_1.default.findOne({
        where: {
            id: id,
        },
        include: [
...
exports.getOneInvestmentPlanCheckOutInDetail = getOneInvestmentPlanCheckOutInDetail;
