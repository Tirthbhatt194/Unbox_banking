...
exports.getOnePolicyInquiryInDetail = void 0;
...
const getOnePolicyInquiryInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // find data at id and join respective foreign key tables to it
    const one = yield policyInquiryModel_1.default.findOne({
        where: {
            id: id,
        },
        include: [
...
exports.getOnePolicyInquiryInDetail = getOnePolicyInquiryInDetail;
