...
exports.getAllPolicyInquiryInDetail = void 0;
...
const getAllPolicyInquiryInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield policyInquiryModel_1.default.findAll({
        include: [
            {
...
exports.getAllPolicyInquiryInDetail = getAllPolicyInquiryInDetail;
