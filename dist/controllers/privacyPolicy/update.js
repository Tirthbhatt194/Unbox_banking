...
exports.updatePrivacyPolicy = void 0;
...
const updatePrivacyPolicy = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const upd = yield privacyPolicyModel_1.default.findOne({
        where: {
            id: id,
        },
    });
    ...
    if (id === id) {
        ...
        const upda = yield privacyPolicyModel_1.default.update(updatePrivacyPolicy, {
            where: {
                id: id,
            },
        });
