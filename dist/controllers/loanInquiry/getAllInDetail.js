...
exports.getAllLoanInquiryInDetail = void 0;
...
const getAllLoanInquiryInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield loanInquiryModel_1.default.findAll({
        include: [
            {
...
exports.getAllLoanInquiryInDetail = getAllLoanInquiryInDetail;
