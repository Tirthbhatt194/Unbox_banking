...
exports.getAllContactUs = void 0;
const contactUsModel_1 = __importDefault(require("../../model/contactUsModel"));
const getAllContactUs = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // Find all data
    const contactUs = yield contactUsModel_1.default.findAll({});
