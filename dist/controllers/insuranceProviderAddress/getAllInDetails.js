...
exports.getAllInsuranceProviderAddressInDetail = void 0;
...
const getAllInsuranceProviderAddressInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield insuranceProviderAddressModel_1.default.findAll({
        include: [
            {
...
exports.getAllInsuranceProviderAddressInDetail = getAllInsuranceProviderAddressInDetail;
