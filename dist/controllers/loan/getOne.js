...
exports.getOneLoan = void 0;
const loan_1 = __importDefault(require("../../model/loan"));
const getOneLoan = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let newLoan = Object.assign(Object.assign({}, loan.dataValues), { details: JSON.parse(loan.dataValues.details) });
