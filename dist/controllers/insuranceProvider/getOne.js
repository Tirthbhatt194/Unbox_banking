...
exports.GetOneProvider = void 0;
const insuranceProviderModel_1 = __importDefault(require("../../model/insuranceProviderModel"));
const GetOneProvider = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // Find data by id and send status with object at that id
    const one = yield insuranceProviderModel_1.default.findOne({
        where: {
            //@ts-ignore
            id: id,
        },
