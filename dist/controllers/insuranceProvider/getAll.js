...
exports.GetAllProvider = void 0;
const insuranceProviderModel_1 = __importDefault(require("../../model/insuranceProviderModel"));
const GetAllProvider = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // Find all data
    const proj = yield insuranceProviderModel_1.default.findAll();
