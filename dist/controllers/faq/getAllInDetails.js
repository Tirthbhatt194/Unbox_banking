...
exports.getAllFaqInDetail = void 0;
...
const getAllFaqInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield faqModel_1.default.findAll({
        include: [
            {
...
exports.getAllFaqInDetail = getAllFaqInDetail;
