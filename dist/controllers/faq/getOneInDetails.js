...
exports.getOneFaqInDetail = void 0;
...
const getOneFaqInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // find data at id and join respective foreign key tables to it
    const one = yield faqModel_1.default.findOne({
        where: {
            id: id,
        },
        include: [
...
exports.getOneFaqInDetail = getOneFaqInDetail;
