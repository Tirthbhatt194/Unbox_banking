...
exports.getAllTestimonial = void 0;
const testimonialModel_1 = __importDefault(require("../../model/testimonialModel"));
const getAllTestimonial = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // Find all data
    const testimonial = yield testimonialModel_1.default.findAll({});
