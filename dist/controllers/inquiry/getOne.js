...
const getOneInquiry = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // Find data by id and send status with object at that id
    const faq = yield inquiry_1.default.findOne({
        where: {
            id: id,
        },
        include: [
...
exports.getOneInquiry = getOneInquiry;
