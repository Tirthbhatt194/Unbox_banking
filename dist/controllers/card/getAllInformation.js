...
const GetAllCardDetails = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let newCard = proj.map((c) => {
        return Object.assign(Object.assign({}, c.dataValues), { details: c.dataValues.details });
    });
