...
exports.getAllOtherInsInquiryInDetail = void 0;
...
const getAllOtherInsInquiryInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield otherInsuranceInquiryModel_1.default.findAll({
        include: [
            {
...
exports.getAllOtherInsInquiryInDetail = getAllOtherInsInquiryInDetail;
