...
exports.getOneMotorCheckOut = void 0;
const motorInsuranceCheckoutModel_1 = __importDefault(require("../../model/motorInsuranceCheckoutModel"));
const getOneMotorCheckOut = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // Find data by id and send status with object at that id
    const motorCheckOutDetail = yield motorInsuranceCheckoutModel_1.default.findOne({
        where: {
            id: id,
        },
    });
...
exports.getOneMotorCheckOut = getOneMotorCheckOut;
