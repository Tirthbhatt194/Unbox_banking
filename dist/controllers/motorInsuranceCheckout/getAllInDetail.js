...
exports.getAllMotorCheckOutInDetail = void 0;
...
const getAllMotorCheckOutInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // find all data and join respective foreign key tables to it
    const proj = yield motorInsuranceCheckoutModel_1.default.findAll({
        include: [
            {
...
exports.getAllMotorCheckOutInDetail = getAllMotorCheckOutInDetail;
