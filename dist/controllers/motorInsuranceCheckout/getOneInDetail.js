...
exports.getOneMotorCheckOutInDetail = void 0;
...
const getOneMotorCheckOutInDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let id = req.params.id;
    // find all data and join respective foreign key tables to it
    const proj = yield motorInsuranceCheckoutModel_1.default.findOne({
        where: {
            id: id,
        },
        include: [
...
exports.getOneMotorCheckOutInDetail = getOneMotorCheckOutInDetail;
